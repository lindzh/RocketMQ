...
public class IndexHeader {
    ...
    public void load() throws IOException {
        ...
        this.beginTimestamp.set(randomAccessFile.readLong());
        this.endTimestamp.set(randomAccessFile.readLong());
        this.beginPhyOffset.set(randomAccessFile.readLong());
        this.endPhyOffset.set(randomAccessFile.readLong());

        this.hashSlotCount.set(randomAccessFile.readInt());
        this.indexCount.set(randomAccessFile.readInt());
